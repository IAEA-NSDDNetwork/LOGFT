...
C+++MDC+++                                                              01 03080
C...ANS                                                                 01 03090
99901 FORMAT(' INPUT DATA SET FILE (TEST.DAT):    ')                    01 03100
99902 FORMAT(' OUTPUT REPORT FILE (LOGFT.RPT):     ')                   01 03110
99903 FORMAT(' DATA TABLE (LOGFT.DAT): ')                               01 03120
99904 FORMAT(' OUTPUT DATA SET FILE (LOGFT.NEW):   ')                   01 03130
C...VAX, DVF, UNX                                                       01 03140
C/99901 FORMAT(' INPUT DATA SET FILE (data.tst):    ',$)                01 03150
C/99902 FORMAT(' OUTPUT REPORT FILE (logft.rpt):     ',$)               01 03160
C/99903 FORMAT(' DATA TABLE (logft.dat): ',$)                           01 03170
C/99904 FORMAT(' OUTPUT DATA SET FILE (logft.new):   ',$)               01 03180
C---MDC                                                                 01 03190
99900 FORMAT(A)                                                         01 03200
C+++MDC                                                                 01 03210
C...ANS, UNX                                                            01 03220
      WRITE(6,99901)                                                    01 03230
      READ(5,99900) LINE                                                01 03240
      IF(LINE.EQ.' ') LINE='data.tst'                                   01 03250
      OPEN(UNIT=35, ACCESS='SEQUENTIAL' ,STATUS='OLD',                  01 03260
     1     FILE=LINE)                                                   01 03270
      WRITE(6,99902)                                                    01 03280
      READ(5,99900) LINE                                                01 03290
      IF(LINE.EQ.' ') LINE='logft.rpt'                                  01 03300
      OPEN(UNIT=36, ACCESS='SEQUENTIAL', STATUS='UNKNOWN',              01 03310
     1     FILE=LINE)                                                   01 03320
      WRITE(6,99903)                                                    01 03330
      READ(5,99900) LINE                                                01 03340
      IF(LINE.EQ.' ') LINE='logft.dat'                                  01 03350
      OPEN(UNIT=20, ACCESS='SEQUENTIAL' ,STATUS='OLD',                  01 03360
     1     FILE=LINE)                                                   01 03370
      WRITE(6,99904)                                                    01 03380
      READ(5,99900) LINE                                                01 03390
      IF(LINE.EQ.' ') LINE='logft.new'                                  01 03400
      OPEN(UNIT=21, ACCESS='SEQUENTIAL' ,STATUS='UNKNOWN',              01 03410
     1     FILE=LINE)                                                   01 03420
C...VAX, DVF                                                            01 03430
C/      WRITE(6,99901)                                                  01 03440
C/      READ(5,99900) LINE                                              01 03450
C/      IF(LINE.EQ.' ') LINE='DATA.TST'                                 01 03460
C/      OPEN(UNIT=35, ACCESS='SEQUENTIAL' ,STATUS='OLD',READONLY,       01 03470
C/     1     FILE=LINE)                                                 01 03480
C/      WRITE(6,99902)                                                  01 03490
C/      READ(5,99900) LINE                                              01 03500
C/      IF(LINE.EQ.' ') LINE='LOGFT.RPT'                                01 03510
C/      OPEN(UNIT=36, ACCESS='SEQUENTIAL', STATUS='UNKNOWN',            01 03520
C/     1     FILE=LINE)                                                 01 03530
C/      WRITE(6,99903)                                                  01 03540
C/      READ(5,99900) LINE                                              01 03550
C...DVF                                                                 01 03560
C/      IF(LINE.EQ.' ') LINE='LOGFT.DAT'                                01 03570
C...VAX                                                                 01 03580
C/      IF(LINE.EQ.' ') LINE='ANALENSDF:LOGFT.DAT'                      01 03590
C...VAX, DVF                                                            01 03600
C/      OPEN(UNIT=20, ACCESS='SEQUENTIAL' ,STATUS='OLD', READONLY,      01 03610
C/     1     FILE=LINE)                                                 01 03620
C/      WRITE(6,99904)                                                  01 03630
C/      READ(5,99900) LINE                                              01 03640
C/      IF(LINE.EQ.' ') LINE='LOGFT.NEW'                                01 03650
C/      OPEN(UNIT=21, ACCESS='SEQUENTIAL' ,STATUS='UNKNOWN',            01 03660
C/     1     CARRIAGECONTROL='LIST', FILE=LINE)                         01 03670
C---MDC---                                                              01 03680
C                                                                       01 03690
      XDATE=' '                                                         01 03700
C+++MDC+++                                                              01 03710
C...DVF, VAX, UNX                                                       01 03720
C/      CALL DATE_20(XDATE)                                             01 03730
C...ANS                                                                 01 03740
C---MDC---                                                              01 03750
C                                                                       01 03760
...
C/      SUBROUTINE DATE_20(DATE)                                        22 00030
C/                                                                      22 00040
C/      CHARACTER DATE*(*)                                              22 00050
C/C                                                                     22 00060
C/C     RETURNS DATE AS A CHARACTER STRING OF 11 CHARACTERS IN THE      22 00070
C/C          FORM  DD-MMM-YYYY                                          22 00080
C/C                                                                     22 00090
C/      Character*3 mon(12)                                             22 00100
C/      Data mon/'Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep', 22 00110
C/     +'Oct','Nov','Dec'/                                              22 00120
C...VAX, DVF                                                            22 00130
C/      Integer im                                                      22 00140
C/      Character*4 ccyy                                                22 00150
C/      Character*2 dd                                                  22 00160
C/      CHARACTER DAY*8                                                 22 00170
C/C                                                                     22 00180
C/C     GET THE DATE AS A CHARACTER STRING CCYYMMDD                     22 00190
C/C                                                                     22 00200
C/      CALL DATE_AND_TIME(DAY)                                         22 00210
C/      Read(day,'(A4,I2,A2)') ccyy,im,dd                               22 00220
C/      WRITE(DATE,FMT='(A2,''-'',A3,''-'',A4)') dd,MON(im),ccyy        22 00230
C...UNX                                                                 22 00240
