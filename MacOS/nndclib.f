...
!          1.6e   08-Jun-2009   Removed RECL in open for formatted 
!                                 file in sort
!          1.7    18-May-2010   Modified ZSYM and IZEL to handle IUPAC
!                                 chemical for Z=112
!          1.7a   05-Jun-2012   Modified ZSYM and IZEL to handle IUPAC
!                                 chemical for Z=114,116
!
!***********************************************************************
!                                                                      *
...
!+++zv2015+++
      IF(Delim.EQ.' ') THEN
	do i=1,iargc()
	    if (i.le.NparMax) then
		call getarg(i,cline)
		npar=i
!		write(*,*) '...tst:arg-',i,trim(cline)
		Carray(Npar)=cline
	    end if
	end do
      END IF
...
!
      ...
      INTEGER(KIND=4),PARAMETER :: NSYM = 116
...
!
     ...
     &     'SG','BH','HS','MT','DS','RG','CN','13','FL','15','LV'/
!
!     ENTRY ZSYM (EL, SYM)
!
      Sym = '  '
...
*JKT 6/8/09 removed RECL for formatted option
C     &             FORM='FORMATTED',RECL=mreco,ACTION='READ')
         ELSE
...
!     Functions used
!
!2015zv      CHARACTER(LEN=*), INTRINSIC :: REPEAT
!
!     Local variables.
!
      INTEGER(KIND=4) :: iend
